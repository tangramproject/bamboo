...
namespace Cli.Configuration
{
    public class Network
    {
        ...
        private readonly IPAddress _nodeTangramIPAddress = IPAddress.Parse("143.198.64.156");
        ...
        {
            UserInterfaceChoice optionNodeTangram = new("Tangram team-managed node (143.198.64.156:7946)");
